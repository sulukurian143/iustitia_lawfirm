...
<html lang="en">
	<head>
		...
		<!-- Favicon -->
		<link rel="icon" type="image/png" sizes="56x56" href="user/images/fav-icon/icon.png">
	...
	<body>
		<div class="main-page-wrapper">
			...
			<header class="theme-main-header">
				<div class="container">
					<a href="index.html" class="logo float-left tran4s"><img src="user/images/logo/logoz.png" alt="Logo"></a>
					...
					<nav class="navbar float-right theme-main-menu one-page-menu">
					   ...
					   <div class="collapse navbar-collapse" id="navbar-collapse-1">
					     <ul class="nav navbar-nav">
							...
							<li><a href="#service-section">LAWYERS</a></li>
							<li><a href="#project-section">PAYMENT</a></li>
							<li><a href="#team-section">NOTIFICATION</a></li>
							<li><a href="#skill-section">FEEDBACK</a></li>
						...
						<div id="main-banner-slider" class="rev_slider video-slider" data-version="5.0.7">
							<ul>
								...
								<li data-index="rs-20" data-transition="fade" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb="video/drinkwinecover.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Title Goes Here" data-description="">
									<!-- MAIN IMAGE -->
									<img src="user/video/drinkwinecover.jpg"  alt="image" class="rev-slidebg" data-bgparallax="3" data-bgposition="center center" data-duration="20000" data-ease="Linear.easeNone" data-kenburns="on" data-no-retina="" data-offsetend="0 0" data-offsetstart="0 0" data-rotateend="0" data-rotatestart="0" data-scaleend="100" data-scalestart="140">
									<!-- LAYERS -->
								...
								<li data-index="rs-18" data-transition="fade" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb="images/home/slide-2.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Title Goes Here" data-description="">
									<!-- MAIN IMAGE -->
									<img src="user/images/home/slide-2.jpg"  alt="image" class="rev-slidebg" data-bgparallax="3" data-bgposition="center center" data-duration="20000" data-ease="Linear.easeNone" data-kenburns="on" data-no-retina="" data-offsetend="0 0" data-offsetstart="0 0" data-rotateend="0" data-rotatestart="0" data-scaleend="100" data-scalestart="140">
									<!-- LAYERS -->
					...
					<div class="project-gallery clear-fix">
						<div class="mix grid-item photo om dmedia">
							<div class="single-img">
								<img src="user/images/project/1.jpg" alt="Image">
								<div class="opacity">
						...
						<div class="mix grid-item web webd dmedia support">
							<div class="single-img">
								<img src="user/images/project/2.jpg" alt="Image">
								<div class="opacity">
									<div class="border-shape"><div><div>
										<h6><a href="#">Sweet Photo</a></h6>
										<ul>
						...
						<div class="mix grid-item photo webd support">
							<div class="single-img">
								<img src="user/images/project/3.jpg" alt="Image">
								<div class="opacity">
									<div class="border-shape"><div><div>
										<h6><a href="#">Sweet Photo</a></h6>
										<ul>
						...
						<div class="mix grid-item web om">
							<div class="single-img">
								<img src="user/images/project/4.jpg" alt="Image">
								<div class="opacity">
									<div class="border-shape"><div><div>
										<h6><a href="#">Sweet Photo</a></h6>
										<ul>
						...
						<div class="mix grid-item photo webd dmedia om">
							<div class="single-img">
								<img src="user/images/project/5.jpg" alt="Image">
								<div class="opacity">
									<div class="border-shape"><div><div>
										<h6><a href="#">Sweet Photo</a></h6>
										<ul>
						...
						<div class="mix grid-item web webd dmedia om">
							<div class="single-img">
								<img src="user/images/project/6.jpg" alt="Image">
								<div class="opacity">
									<div class="border-shape"><div><div>
										<h6><a href="#">Sweet Photo</a></h6>
										<ul>
						...
						<div class="mix grid-item photo om support">
							<div class="single-img">
								<img src="user/images/project/7.jpg" alt="Image">
								<div class="opacity">
									<div class="border-shape"><div><div>
										<h6><a href="#">Sweet Photo</a></h6>
										<ul>
						...
						<div class="mix grid-item web support">
							<div class="single-img">
								<img src="user/images/project/8.jpg" alt="Image">
								<div class="opacity">
									<div class="border-shape"><div><div>
										<h6><a href="#">Sweet Photo</a></h6>
										<ul>
						...
						<div class="mix grid-item photo webd dmedia support">
							<div class="single-img">
								<img src="user/images/project/9.jpg" alt="Image">
								<div class="opacity">
									<div class="border-shape"><div><div>
										<h6><a href="#">Sweet Photo</a></h6>
										<ul>
				...
				<div class="container">
					...
					<div class="clear-fix team-member-wrapper">
						...
						<div class="float-left">
							<div class="single-team-member">
								<div class="img">
									<img src="user/images/team/2.jpg" alt="Image">
									<div class="opacity tran4s">
						...
						<div class="float-left">
							<div class="single-team-member">
								<div class="img">
									<img src="user/images/team/3.jpg" alt="Image">
									<div class="opacity tran4s">
				...
				<div class="container">
					<div class="clear-fix">
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<div class="img"><img src="user/images/home/2.jpg" alt="Image"></div>
						</div> <!-- /.col- -->
			...
			<div id="our-client">
				<div class="container">
					...
					<div class="client-slider">
						<div class="item">
							<img src="user/images/home/c1.jpg" alt="Client">
						...
						<div class="item">
							<img src="user/images/home/c2.jpg" alt="Client">
							<p>Our successful construction approach is based on aggressive subcontractor administration, employ-ment of competent personnel, accurate schedule control, quality control and cost control. We employ only qualified subcontractors who share our goal in creating quality projects.</p>
							<h6>- Spryte Loriano -</h6>
						</div> <!-- /.item -->
						<div class="item">
							<img src="user/images/home/c3.jpg" alt="Client">
							<p>Our successful construction approach is based on aggressive subcontractor administration, employ-ment of competent personnel, accurate schedule control, quality control and cost control. We employ only qualified subcontractors who share our goal in creating quality projects.</p>
							<h6>- Spryte Loriano -</h6>
						</div> <!-- /.item -->
					</div> <!-- /.client-slider -->
					...
					<div class="clear-fix">
						<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
							<div class="single-news-item">
								<div class="img"><img src="user/images/blog/1.jpg" alt="Image">
						...
						<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
							<div class="single-news-item">
								<div class="img"><img src="user/images/blog/2.jpg" alt="Image">
									<a href="blog-details.html" class="opacity tran4s"><i class="fa fa-link" aria-hidden="true"></i></a>
								</div> <!-- /.img -->
						...
						<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
							<div class="single-news-item">
								<div class="img"><img src="user/images/blog/3.jpg" alt="Image">
									<a href="blog-details.html" class="opacity tran4s"><i class="fa fa-link" aria-hidden="true"></i></a>
								</div> <!-- /.img -->
			...
			<div id="partner-section">
				<div class="container">
					<div id="partner_logo" class="owl-carousel owl-theme">
						<div class="item"><img src="user/images/logo/p1.png" alt="logo"></div>
						<div class="item"><img src="user/images/logo/p2.png" alt="logo"></div>
						<div class="item"><img src="user/images/logo/p3.png" alt="logo"></div>
						<div class="item"><img src="user/images/logo/p4.png" alt="logo"></div>
						<div class="item"><img src="user/images/logo/p5.png" alt="logo"></div>
						<div class="item"><img src="user/images/logo/p2.png" alt="logo"></div>
			...
			<footer>
				<div class="container">
					<a href="index.html" class="logo"><img src="user/images/logo/logo.png" alt="Logo"></a>
					...
					<p>Copyright @2018 All rights reserved | Sulu Kurian <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a></p>
				</div>
			</footer>
		...
		<!-- revolution -->
		<script src="user/vendor/revolution/jquery.themepunch.tools.min.js"></script>
		<script src="user/vendor/revolution/jquery.themepunch.revolution.min.js"></script>
		<script type="text/javascript" src="user/vendor/revolution/revolution.extension.slideanims.min.js"></script>
		<script type="text/javascript" src="user/vendor/revolution/revolution.extension.layeranimation.min.js"></script>
		<script type="text/javascript" src="user/vendor/revolution/revolution.extension.navigation.min.js"></script>
		<script type="text/javascript" src="user/vendor/revolution/revolution.extension.kenburn.min.js"></script>
		<script type="text/javascript" src="user/vendor/revolution/revolution.extension.actions.min.js"></script>
		<script type="text/javascript" src="user/vendor/revolution/revolution.extension.video.min.js"></script>
		...
		<script src="user/vendor/gmaps.min.js"></script>
		<!-- owl.carousel -->
		<script type="text/javascript" src="user/vendor/owl-carousel/owl.carousel.min.js"></script>
		<!-- mixitUp -->
		<script type="text/javascript" src="user/vendor/jquery.mixitup.min.js"></script>
		<!-- Progress Bar js -->
		<script type="text/javascript" src="user/vendor/skills-master/jquery.skills.js"></script>
		<!-- Validation -->
		<script type="text/javascript" src="user/vendor/contact-form/validate.js"></script>
		<script type="text/javascript" src="user/vendor/contact-form/jquery.form.js"></script>


		<!-- Theme js -->
		<script type="text/javascript" src="user/js/theme.js"></script>
		<script type="text/javascript" src="user/js/map-script.js"></script>
