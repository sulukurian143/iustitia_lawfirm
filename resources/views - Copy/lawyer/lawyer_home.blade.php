...
<html>
	...
	<!-- Animate.css -->
	<link rel="stylesheet" href="lawyer/css/animate.css">
	<!-- Icomoon Icon Fonts-->
	<link rel="stylesheet" href="lawyer/css/icomoon.css">
	<!-- Themify Icons-->
	<link rel="stylesheet" href="lawyer/css/themify-icons.css">
	<!-- Bootstrap  -->
	<link rel="stylesheet" href="lawyer/css/bootstrap.css">
	<!-- Magnific Popup -->
	<link rel="stylesheet" href="lawyer/css/magnific-popup.css">
	<!-- Owl Carousel  -->
	<link rel="stylesheet" href="lawyer/css/owl.carousel.min.css">
  <link rel="stylesheet" href="lawyer/css/drop.css">
	<link rel="stylesheet" href="lawyer/css/owl.theme.default.min.css">
	<!-- Flexslider -->
	<link rel="stylesheet" href="lawyer/css/flexslider.css">
	<!-- Theme style  -->
	<link rel="stylesheet" href="lawyer/css/style.css">

	<!-- Modernizr JS -->
	<script src="lawyer/js/modernizr-2.6.2.min.js"></script>
	<!-- FOR IE9 below -->
	<!--[if lt IE 9]>
	...
	<nav class="gtco-nav" role="navigation">
		<div class="container">
            ...
            <li><a href="#" data-nav-section="contact">Contact</a></li>
                <div class="dropdown">
                  <button class="dropbtn">{{Session::get('email')}}
                  ...
                  <div class="dropdown-content">
                    ...
                    <a href="/logout">Signout</a>
						...
						<!-- <li class="btn-cta"><a href="#" data-nav-section="contact"><span>{{Session::get('email')}}</span></a></li> -->
	...
	<section id="gtco-hero" class="gtco-cover" style="background-image: url(lawyer/images/img_bg_4.jpg);"  data-section="home"  data-stellar-background-ratio="0.5">
			...
			<div class="row">
				<div class="col-md-6 col-md-pull-1 animate-box" data-animate-effect="fadeInLeft">
					<div class="img-shadow">
						<img src="lawyer/images/img_1.jpg" class="img-responsive" alt="Free HTML5 Bootstrap Template by FreeHTML5.co">
					</div>
				</div>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="gtco-practice-area-item animate-box">
						<div class="gtco-icon">
							<img src="lawyer/images/scale.png" alt="Free HTML5 Bootstrap Template by FreeHTML5.co">
						</div>
						<div class="gtco-copy">
							<h3>Criminal Law</h3>
		...
		<div class="container">
			...
			<div class="row team-item gtco-team-reverse">
				<div class="col-md-6 col-md-push-7 animate-box" data-animate-effect="fadeInRight">
					<div class="img-shadow">
						<img src="lawyer/images/img_team_1.jpg" class="img-responsive" alt="Free HTML5 Bootstrap Template by FreeHTML5.co">
					</div>
				</div>
			...
			<div class="row team-item gtco-team">
				<div class="col-md-6 col-md-pull-1 animate-box"  data-animate-effect="fadeInLeft">
					<div class="img-shadow">
						<img src="lawyer/images/img_team_2.jpg" class="img-responsive" alt="Free HTML5 Bootstrap Template by FreeHTML5.co">
					</div>
				</div>
				<div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
	...
	<!-- jQuery Easing -->
	<script src="lawyer/js/jquery.easing.1.3.js"></script>
	<!-- Bootstrap -->
	<script src="lawyer/js/bootstrap.min.js"></script>
	<!-- Waypoints -->
	<script src="lawyer/js/jquery.waypoints.min.js"></script>
	<!-- Stellar -->
	<script src="lawyer/js/jquery.stellar.min.js"></script>
	<!-- Magnific Popup -->
	<script src="lawyer/js/jquery.magnific-popup.min.js"></script>
	<script src="lawyer/js/magnific-popup-options.js"></script>
	<!-- Main -->
	<script src="lawyer/js/main.js"></script>
