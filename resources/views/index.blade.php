	...
	<nav class="colorlib-nav" role="navigation">
		<div class="top-menu">
			<div class="container">
				<div class="row">
					<div class="col-md-2">
						<div id="colorlib-logo">Iustistia</div>
					</div>
					<div class="col-md-10 text-right menu-1">
						<ul>
							<li class="active"><a href="#">Home</a></li>
							<li><a href="/registrations/create">Sign up</a></li>
							<li><a href="/logins/create">Login</a></li>
	...
	<footer id="colorlib-footer" role="contentinfo">
			...
			<div class="row copyright">
				<div class="col-md-12 text-center">
					<p>
					<small class="block">&copy; 2018 Iustitia. All Rights Reserved. Created by Iustitia</a></small> 
