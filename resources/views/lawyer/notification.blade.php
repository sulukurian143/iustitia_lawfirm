...
<section id="content">
  <div class="container">
    ...
    <div>
    <!-- <form method="POST" action="/noti_approve" > -->
    <form method="POST" action="#" >
                    ...
                    @foreach($a as $user)
                    <tr>
                        <input type="text" id="id" hidden  name="id" value="{{ $user->id }}"/>
                        <input type="text" hidden  name="email" value="{{ $user->email }}"/>
                        <td><input type="text" readonly name="uemail" value="{{ $user->uemail }}"/></td>
                        <td><input type="text" readonly name="qs1" value="{{ $user->q1 }}"/></td>
                        <td><input type="text" readonly name="qs2" value="{{ $user->q2 }}"/></td>
                        <td><input type="button" name="button" id="button" value="Accept" onclick="myFunction1('Accept')">
                        <td><input type="button" name="button" id="button" value="Reject" onclick="myFunction1('Reject')"> 
                      </td>
                    </tr>
  ...
  var data = { 'id': id,'_token':$('meta[name="csrf-token"]').attr('content') ,'text':a};
  $.ajax({
    url: "/law_noti_update",
    data: data,
