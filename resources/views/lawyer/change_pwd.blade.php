...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/fullcalendar/3.4.0/fullcalendar.css" />
  ...
  <script src="lawyer/js/pwd_validations.js"></script> 
  <style type="text/css">
...
?>
	Email:<input type="text" name="email" value="{{Session::get('email')}}" disabled>
            
                <br><br>
                
                Current Password: <input type="password" name="cupass" class="form-control" placeholder="Your current password" required />
                
                New Password:<input type="password" name="pass" class="form-control" placeholder="Your new password" required />
                
                Confirm Password:<input type="password" name="conpass" class="form-control" placeholder="Confirm password" required />
