...
<section id="content">
  <div class="container">
    ...
    <form action="/emg_lawyer_set" method="post">
    @csrf
    <table border="1px solid black">
      ...
      <tr>
        <td><input type="date" name="date" id="to" onchange="DateCheck()"></td>
...
?>
      ...
      <input type="text"  name="email" hidden value="{{Session::get('email')}}">
