...
<body>
            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
  <a class="has-arrow" href="mailbox.html" aria-expanded="false"><i class="icon nalika-diamond icon-wrap"></i> <span class="mini-click-non">Users</span></a>
  <ul class="submenu-angle" aria-expanded="false">
  <li><a title="Google Map" href="/man_bluser"><span class="mini-sub-pro">Blocked</span></a></li>
  <li><a title="Data Maps" href="/man_user"><span class="mini-sub-pro">Unblocked</span></a></li></ul>
  <a class="has-arrow" href="mailbox.html" aria-expanded="false"><i class="icon nalika-diamond icon-wrap"></i> <span class="mini-click-non">Lawyers</span></a>
  <ul class="submenu-angle" aria-expanded="false">
  <li><a title="Google Map" href="/man_bllawyer"><span class="mini-sub-pro">Blocked</span></a></li>
  <li><a title="Data Maps" href="/man_lawyer"><span class="mini-sub-pro">Unblocked</span></a></li>
  <a class="has-arrow" href="mailbox.html" aria-expanded="false"><i class="icon nalika-diamond icon-wrap"></i> <span class="mini-click-non">Approve</span></a></ul>
  <ul class="submenu-angle" aria-expanded="false">
  <li><a title="Google Map" href="/usapprove"><span class="mini-sub-pro">Users</span></a></li>
  <li><a title="Data Maps" href="/laapprove"><span class="mini-sub-pro">Lawyers</span></a></li>
    ...
    <div class="all-content-wrapper">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcomb-wp">
											...
											<div class="breadcomb-ctn">
												<h2>Iustitia</h2>
												<p>Welcome Aridotado <span class="bread-ntd"></span></p>
											</div>
										</div>
                                    </div>
                                    <!-- <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                        <div class="single-new-trend mg-t-30">
                            <a href="#"><img src="admin/img/new-product/5.png" alt=""></a>
        ...
        <div class="product-sales-area mg-tb-30">
        <form name="f1" method="POST" action="/user_approve" enctype="multipart/form-data">
        @csrf
        <table style=""  cellspacing="0">
  <center> <tr bgcolor="#A9A9A9">
  ...
  $proof=$us->proof; ?>
      ...
      <input type="hidden" value= "{{$us->id}}" name="id"/>
            <td ><input type="text" name="name" value="{{$us->fname}} {{$us->lname}}"></td>
        <td><input type="text" name="gender" value="{{$us->gender}}"></td>
        <td><input type="text" name="email" value="{{$us->email}}"></td>
        <td><a href="/proof?id={{$us->id}}" target="_blank">Click</a></td>
        <!-- <td><img src="../../../ankitha/{{$proof }}" style="width:150px;height:200px;"/></td> -->
        <td><input type="text" name="phone" value="{{$us->phone}}"></td>
        <td><input type="submit" name="button" value="Action"></td>
      </tr>
 ...
 <!-- <td><input id="submit" type="submit" name="submit" value="" /></td> -->
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="personal-info-wrap">
                            <div class="widget-head-info-box">
                                ...
                                <img src="admin/img/notification/5.jpg" class="img-circle circle-border m-b-md" alt="profile">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="author-widgets-single res-mg-t-30">
                            <div class="author-wiget-inner">
                                <div class="perso-img">
                                    <img src="admin/img/notification/6.jpg" class="img-circle circle-border m-b-md" alt="profile">
                                </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="personal-info-wrap personal-info-ano res-mg-t-30">
                            <div class="widget-head-info-box">
                                ...
                                <img src="admin/img/contact/2.jpg" class="img-circle circle-border m-b-md" alt="profile">
                                <div class="social-widget-result">
                                    <span>100 Tweets</span> |
                                    <span>350 Following</span> |
                                    <span>610 Followers</span>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p>Copyright © 2018 Sulu Kurian</a> All rights reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
