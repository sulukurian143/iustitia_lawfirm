...
<body id="page-top">
          ...
          <div class="card-header">
            <!-- <i class="fas fa-chart-area"></i> -->
                        <!-- Area Chart Example</div> -->
                              <p>If you want an appointment, first let me know...
						      <a href="#" data-toggle="modal" data-target="#appointmentModal">Click here</a>
      <!-- <input type="submit" name="appointment" value="Request for an appointment"> -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <input type="text" name="email" hidden value="<?php echo $email; ?>"><br><br>
      <input type="text" name="uemail" hidden value="<?php echo $uemail; ?>"><br><br>
        Title<input type="text" name="q1"><br><br>
        Is there enough evidence/proof? <input type="text" name="q2">
