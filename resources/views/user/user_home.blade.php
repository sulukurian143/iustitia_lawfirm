    ...
    <ul class="navbar-nav ml-auto ml-md-0">
      <li class="nav-item dropdown no-arrow mx-1">
        ...
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="alertsDropdown">
          ...
          @foreach ($userz as $u)
      <div><center> Your request for {{$u->q1}} is {{$u->button}} by Adv.{{$u->fname}} {{$u->lname}}  <a href="{{route('us_home',$u->id)}}" >OK</a>
      </center></div>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-primary o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5">{{$p}} Lawyers!</div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="/my_lawyer">
