    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
          <form action="/app_get" method="POST">
          @csrf
      ...
      <!-- <input type="text" name="email" value=""> -->
        ...
        <!-- $name=$users->fname; -->
        <tr><td>Adv.<input type="text" name="name" value="{{$users[0]->fname}} {{$users[0]->lname}}" disabled></td>
        <td><input type="text" name="email" value="{{$users[0]->email}}" readonly></td>
        <td><input type="text" name="rate" value="{{$users[0]->rating}}/5" disabled></td>
        <!-- <td><input type="submit" name="appointment" value="Request for an appointment"></td> -->
        <td><a href="{{route('app_get',$users[0]->email)}} " Clasq="btn btn-primary">Request</td>
      </tr>
      @endforeach
      </form>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <input type="text" name="email" value=><br><br>
        Your name  <input type="text" name="q1"><br><br>
