  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
        ...
        <div class="card mb-3">
          <div class="card-header">
            <!-- <i class="fas fa-chart-area"></i> -->
						...
						<div></div>
          <div class="card-body">
          <form action="/user_noti" method="POST">
          @csrf
      ...
      <!-- <input type="text" name="email" value=""> -->
        ...
        <td><a href="{{route('user_noti',$users->email)}} " Clasq="btn btn-primary">Request for an appointment</td>
        <!-- <td><input type="submit" name="button" value="Request for an appointment"></td>
        <td><input type="submit" name="button" value="Remove"></td> -->
        
        <!-- <td><input type="button" data-toggle="modal" data-target="#appointmentModal" name="document" value="Documents"></td> -->
      </tr>
      @endforeach
      </form>
