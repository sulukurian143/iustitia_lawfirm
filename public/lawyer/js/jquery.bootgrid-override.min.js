    ...
    */
    ...
    function renderPagination()
    {
        if (this.options.navigation !== 0)
        {
            ...
            if (this.rowCount !== -1 && (headerPagination.length + footerPagination.length) > 0)
            {
                ...
                renderPaginationItem.call(this, pagination, "first", "<i class='jtv jtv-more-horiz'></i>", "first")
                    ._bgEnableAria(current > 1);
                renderPaginationItem.call(this, pagination, "prev", "<i class='jtv jtv-chevron-left'></i>", "prev")
                    ._bgEnableAria(current > 1);
                ...
                renderPaginationItem.call(this, pagination, "next", "<i class='jtv jtv-chevron-right'></i>", "next")
                    ._bgEnableAria(totalPages > current);
                renderPaginationItem.call(this, pagination, "last", "<i class='jtv jtv-more-horiz'><i>", "last")
                    ._bgEnableAria(totalPages > current);
    ...
    Grid.defaults = {
        ...
        templates: {
            ...
            actionDropDownCheckboxItem: "<li class=\"p-l-10\"><div class=\"checkbox cr-alt\"><label class=\"p-l-25 {{css.dropDownItem}}\"><input name=\"{{ctx.name}}\" type=\"checkbox\" value=\"1\" class=\"{{css.dropDownItemCheckbox}}\" {{ctx.checked}} /><i class=\"input-helper\"></i> {{ctx.label}}</label></div></li>",
            ...
            search: "<div class=\"{{css.search}}\"><div class=\"input-group\"><span class=\"{{css.icon}} input-group-addon jtv-search\"></span> <input type=\"text\" class=\"{{css.searchField}}\" placeholder=\"{{lbl.search}}\" /></div></div>",
            select: "<div class=\"checkbox cr-alt\"><label><input name=\"select\" type=\"{{ctx.type}}\" class=\"{{css.selectBox}}\" value=\"{{ctx.value}}\" {{ctx.checked}} /><i class=\"input-helper\"</label></div>"
        }
    };
